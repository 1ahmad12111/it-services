...
const Testimonials = () => {
  return (
    <section className="py-16 bg-consulting-900 text-white">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-consulting-800 rounded-lg p-8 shadow-lg">
              <svg 
                className="h-8 w-8 text-consulting-500 mb-4" 
                fill="currentColor" 
                viewBox="0 0 24 24"
              >
                <path d="M14.017 21v-7.391c0-5.704 3.731-9.57 8.983-10.609l.995 2.151c-2.432.917-3.995 3.638-3.995 5.849h4v10h-9.983zm-14.017 0v-7.391c0-5.704 3.748-9.57 9-10.609l.996 2.151c-2.433.917-3.996 3.638-3.996 5.849h3.983v10h-9.983z" />
              </svg>
              <p className="mb-6 text-consulting-100">{testimonial.quote}</p>
              <Separator className="bg-consulting-700 mb-6" />
              <div>
                <h4 className="font-bold">{testimonial.author}</h4>
                <p className="text-sm text-consulting-300">{testimonial.position}</p>
              </div>
            </div>
          ))}
        </div>
