...
const services = [
  {
    icon: <Globe className="h-10 w-10 text-positivus-dark" />,
    ...
    <section className="py-24 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-positivus-dark">Our Solutions Portfolio</h2>
          ...
          {services.map((service, index) => (
            <Card key={index} className="hover:shadow-lg transition-shadow border-none shadow-md h-full bg-white">
              <CardHeader>
                ...
                <CardTitle className="text-xl text-positivus-dark">{service.title}</CardTitle>
              </CardHeader>
