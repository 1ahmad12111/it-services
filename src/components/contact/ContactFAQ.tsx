        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-3 text-coral">What are your typical business hours?</h3>
            ...
            {/* FAQ Item 2 */}
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-3 text-coral">How quickly can you respond to a service request?</h3>
              <p className="text-gray-600">
            ...
            {/* FAQ Item 3 */}
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-3 text-coral">Do you offer remote consultations?</h3>
              <p className="text-gray-600">
            ...
            {/* FAQ Item 4 */}
            <div className="bg-white p-6 rounded-lg shadow-md">
              <h3 className="text-xl font-bold mb-3 text-coral">What is your project onboarding process?</h3>
              <p className="text-gray-600">
